...
I highly recommend that you [replicate code in the slides as I go](https://github.com/afre-msu/AFRE-891-991-FS26/tree/5b9679b7c2e988f9f1a7f1e92a84c985aaf1441b/Lecture%20Slides/01-R-Intro).super[.pink[†]].
...
(Read the whole thing here: [891](https://github.com/afre-msu/AFRE-891-991-FS26/blob/5b9679b7c2e988f9f1a7f1e92a84c985aaf1441b/Course%20Logistics/AFRE%20891/Syllabus%20AFRE%20891%20FS26.pdf), [991](https://github.com/afre-msu/AFRE-891-991-FS26/blob/5b9679b7c2e988f9f1a7f1e92a84c985aaf1441b/Course%20Logistics/AFRE%20991/Syllabus%20AFRE%20991%20FS26.pdf))
...
| .hi-purple[Final Project] | 20% |
  ...
  * .hi-purple[Final project] relates to applying course methods + research supply chain
    * Different specifics for 891/991 (posted in the "Course Logistics" folders)
      * [891](https://github.com/afre-msu/AFRE-891-991-FS26/blob/0ee472dbced552e1fde9a688d5003dbba578e134/Course%20Logistics/AFRE%20891/Final%20Project%20Description%20AFRE%20891%20FS26.pdf)
      * [991](https://github.com/afre-msu/AFRE-891-991-FS26/blob/0ee472dbced552e1fde9a688d5003dbba578e134/Course%20Logistics/AFRE%20991/Final%20Project%20Description%20AFRE%20991%20FS26.pdf)
---
# Final Project: 891
...
Both project types involve
  ...
  1. .hi-slate[Project Proposal]: brief summary of the paper you have selected and why, and how the replication package is organized (Due Friday, October 16)
  1. .hi-slate[Material Submission]: Fully documented R Markdown file walking through full replication process or conducting data acquisition (Due Sunday December 6)
  1. .hi-slate[Discussant]: work through assigned student's material submission and prepare 3 minute presentation on your experience (Due Friday, December 11)
  1. .hi-slate[Presentation]: 8-10 minute conference-style presentation sharing what you did with fellow students (Finals Week, specific time TBD)
]
...
Project deliverables include
  ...
  1. .hi-slate[Project Prospectus]: one-page prospectus outlining the proposed project and planned direction (Due Friday, October 16)
  1. .hi-slate[Replication Package]: Fully replication package containing all necessary data/code and documentation needed to replicate your project (Due Sunday December 6)
  1. .hi-slate[Discussant]: work through assigned student's replication package and prepare 3 minute presentation on how it went/any issues (Due Friday, December 11)
  1. .hi-slate[Presentation]: 8-10 minute conference-style presentation summarizing your project (Finals Week, specific time TBD)
  ]
]
...
The whole thing's in the syllabus, but in short:

  * The point of this class is to develop competency coding in R
  * You do that by practicing it. Yourself.
  * genAI *can* be a part of the researcher's workflow, but first you need sufficient expertise to evaluate whether its output actually makes sense or is hallucinated `r fa('trash')`
  * As such, genAI is **not allowed** on homeworks
  * If you get stuck on homework, consult
    * your fellow students
    * R documentation
    * [StackOverflow's R community](https://stackoverflow.com/questions/tagged/r?tab=Newest)
...
* Create an account on [GitHub](https://github.com/) and register for a [student/educator  discount](https://education.github.com)
    * You will soon receive an invitation to [Classroom 50](https://github.com/foundation50/classroom50/wiki/Web-Student-Guide). This is how I'll distribute template GitHub repositories for assignments.
...
In R, `NA` contains .hi-blue[no information] and can't be used in expressions/arguments

  * We'll see how to handle these in summary stats later
