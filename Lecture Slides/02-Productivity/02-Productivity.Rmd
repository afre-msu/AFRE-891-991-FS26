...
knitr::include_graphics("images/phd052810s.gif")
```
]
---
...
We're going to focus primarily on **4**, but the back of the deck will contain slides working through **3** if you want to experiment with that on your own too.
...
In order to clone a repo, we first need a repo to clone. Let's start by cloning our [Course repo!](https://github.com/afre-msu/AFRE-891-991-FS26)
...
Let's start with the first approach. With GitHub Desktop installed/open, navigate to our [class web page repo](https://github.com/afre-msu/AFRE-891-991-FS26).



.center[
```{r, echo = F, out.width = "100%"}
knitr::include_graphics("images/clone_course_repo_1.png")
```
]
...
.center[
```{r, echo = F, out.width = "100%"}
knitr::include_graphics("images/clone_course_repo_2.png")
```
]
...
knitr::include_graphics("images/clone_course_repo_3.png")
```
]
...
.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/clone_course_repo_4.png")
```
]
...
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/create_repo1.png")
```
...
knitr::include_graphics("images/create_repo2.png")
```
]
---
# Create a Repository on GitHub (Repo)
...
.center[
```{r, echo = F, out.width= "850"}
knitr::include_graphics("images/create_repo3.png")
```
]
...
.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/create_repo4.png")
```
]
...
.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/create_repo5.png")
```
]
...
.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/create_repo6.png")
```
]
...
.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/create_repo7.png")
```
]
...
.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/create_repo8.png")
```
]
...
.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/edit_readme_1.png")
```
]
]
...
.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/edit_readme_2.png")
```
]
]
...
.center[
```{r, echo = F, out.width= "96%"}
knitr::include_graphics("images/stage_desktop_1.png")
```
]
...
.hi-slate[GitHub]
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/edit_readme_3.png")
```
]
]
...
knitr::include_graphics("images/commit_desktop.png")
```
]
...
.center[
```{r, echo = F, out.width= "96%"}
knitr::include_graphics("images/push_desktop_1.png")
```
]
]
...
.center[
```{r, echo = F, out.width= "96%"}
knitr::include_graphics("images/push_desktop_2.png")
```
]
...
.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/push_desktop_3.png")
```
]
...
.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/edit_github_1.png")
```
]
...
.vcenter.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/edit_github_2.png")
```
]
...
knitr::include_graphics("images/edit_github_3.png")
```
]
...
.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/edit_github_4.png")
```
]
...
.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/pull_desktop_1.png")
```
]
...
.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/pull_desktop_2.png")
```
]
...
.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/pull_desktop_3.png")
```
]
...
knitr::include_graphics("images/connectedpapers.png")
```
]
.less-right[
...
# Not Covered: Git(Hub) and RStudio 
...
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/add_rstudio1.png")
```
...
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/add_rstudio2.png")
```
...
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/add_rstudio3.png")
```
...
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/add_rstudio4.png")
```
...
.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/stage_commit1.png")
```
...
.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/stage_commit2.png")
```
]
---
# Stage and Commit
.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/stage_commit3.png")
```
]
---
# Pull
...
.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/push_signin.png")
```
]
---
# Sign RStudio into Github
.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/push_signin2.png")
```
]
---
# Changes Now Visible on Github
.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/github_changes.png")
```
]
---
...
.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/local_changes.png")
```
]
...
knitr::include_graphics("images/gitcred_rstudio.png")
```
]
...
knitr::include_graphics("images/gitcred_pat.png")
```
]
...
.center[
```{r, echo = F, out.width= "550"}
knitr::include_graphics("images/sitrep.png")
```
]
